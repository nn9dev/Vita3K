...
struct NullAudioOutPort : AudioOutPort {
    ~NullAudioOutPort();
};

class NullAudioAdapter : public AudioAdapter {
    NullAudioOutPort out_port;

public:
    NullAudioAdapter(AudioState &audio_state);
    ~NullAudioAdapter() override;
