...
#include <arm_dyncom/skyeye_common/vfp/vfp_helper.h> /* for references to cdp SoftFloat functions */

#define VFP_DEBUG_UNTESTED(x) LOG_TRACE("in func {}, " #x " untested", __FUNCTION__);
