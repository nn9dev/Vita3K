...
const InstructionSetEncodingItem arm_instruction[] = {
    ...
    { "vcvt(bhs)", 5, ARMVFP3, { 23, 27, 0x1D, 17, 21, 0x19, 8, 11, 0xA, 6, 6, 1, 4, 4, 0 }},
    ...
    // resolve barriers & PLI to NOP
    { "dmb", 1, 6,         { 4, 31, 0x0f57ff05 }},
    { "dsb", 1, 6,         { 4, 31, 0x0f57ff04 }},
    { "isb", 1, 6,         { 4, 31, 0x0f57ff06 }},
    { "pli", 3, 6,         { 24, 31, 0x000000f4, 20, 22, 0x00000005, 12, 15, 0x0000000f }},
    { "pli", 4, 6,         { 24, 31, 0x000000f6, 20, 22, 0x00000005, 12, 15, 0x0000000f, 4, 4, 0x00000000 }},
    ...
    { "mls", 2, 0,         { 21, 27, 0x00000003, 4, 7, 0x00000009 }},
    { "movw", 1, 6,        { 20, 27, 0x00000030 }},
    { "movt", 1, 6,        { 20, 27, 0x00000034 }},
    ...
    { "bfc", 3, 6,         { 21, 27, 0x0000003e, 4, 6, 0x00000001, 0, 3, 0x0000000f }},
    { "bfi", 2, 6,         { 21, 27, 0x0000003e, 4, 6, 0x00000001 }},
    { "rbit", 4, 6,        { 20, 27, 0x0000006f, 16, 19, 0x0000000f, 8, 11, 0x0000000f, 4, 7, 0x00000003 }},
    { "sbfx", 2, 6,        { 21, 27, 0x0000003d, 4, 6, 0x00000005 }},
    { "ubfx", 2, 6,        { 21, 27, 0x0000003f, 4, 6, 0x00000005 }},
    { "sdiv", 3, 6,        { 20, 27, 0x00000071, 12, 15, 0x0000000f, 4, 7, 0x00000001 }},
    { "udiv", 3, 6,        { 20, 27, 0x00000073, 12, 15, 0x0000000f, 4, 7, 0x00000001 }},
    // UDF (undefined) -> NOP
    { "udf", 2, 6,         { 20, 27, 0x0000007f, 4, 7, 0x0000000f }},
    ...
    { "strht", 5, 0,       { 25, 27, 0x00000000, 24, 24, 0x00000000, 21, 21, 0x00000001, 20, 20, 0x00000000, 4, 7, 0x0000000b }},
    { "ldrht", 5, 0,       { 25, 27, 0x00000000, 24, 24, 0x00000000, 21, 21, 0x00000001, 20, 20, 0x00000001, 4, 7, 0x0000000b }},
    { "ldrsbt", 5, 0,      { 25, 27, 0x00000000, 24, 24, 0x00000000, 21, 21, 0x00000001, 20, 20, 0x00000001, 4, 7, 0x0000000d }},
    { "ldrsht", 5, 0,      { 25, 27, 0x00000000, 24, 24, 0x00000000, 21, 21, 0x00000001, 20, 20, 0x00000001, 4, 7, 0x0000000f }},
    ...
    { "csdb", 1, 6,        { 0, 27, 0x0320f014 }},  // nop
    { "dbg", 1, 6,         { 4, 27, 0x0320f0f }},   // nop
...
const InstructionSetEncodingItem arm_exclusion_code[] = {
    ...
    { "stm", 0, 0,         { 0 }},
    { "ldm", 0, 0,         { 0 }},
    { "ldrsh", 2, 2,       { 24, 24, 0x00000000, 21, 21, 0x00000001 }},
    { "stm", 0, 0,         { 0 }},
    { "ldm", 0, 0,         { 0 }},
    { "ldrsb", 2, 2,       { 24, 24, 0x00000000, 21, 21, 0x00000001 }},
    { "strd", 0, 4,        { 0 }},
    { "ldrh", 2, 0,        { 24, 24, 0x00000000, 21, 21, 0x00000001 }},
    { "strh", 2, 0,        { 24, 24, 0x00000000, 21, 21, 0x00000001 }},
    { "ldrd", 0, 4,        { 0 }},
    { "bfc", 0, 6,         { 0 }},
    { "bfi", 0, 6,         { 0 }},
    { "rbit", 0, 6,        { 0 }},
...
ARMDecodeStatus DecodeARMInstruction(u32 instr, int* idx) {
    ...
    for (int i = 0; i < instr_slots; i++) {
        ...
        // 3DS has no VFP3 support, but PS Vita does!
